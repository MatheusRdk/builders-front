    ...
    const handleCreation = async () => {
      try{
        ...
        const res = await axios.post(
            'http://ec2-52-91-90-91.compute-1.amazonaws.com:80/architects',
            { name },
          ...
          if (res.status === 201) {
            ...
            setMessage('Arquiteto cadastrado com sucesso!');
          } else {
            setMessage('Erro ao cadastrar arquiteto. Por favor, tente novamente.');
          }
        } catch (error) {
          console.error('Erro ao cadastrar arquiteto:', error);
          setMessage('Erro ao cadastrar arquiteto. Por favor, tente novamente.');
        }
      };
      ...
      return (
        <div className='flex-container p-6 rounded-md mx-auto max-w-md'>
          <h1 className="text-3xl font-bold mb-4 text-center font-urbanist">Cadastrar novo arquiteto</h1>
